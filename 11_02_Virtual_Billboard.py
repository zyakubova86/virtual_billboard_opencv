...
img_src = cv2.imread('D:\\django_projects\\!opencv\\module11-geometric-transformation-and-homography\\Applications\\Apollo-8-Launch.png')

# Read the destination image.
img_dst = cv2.imread("D:\\django_projects\\!opencv\\module11-geometric-transformation-and-homography\\Applications\\times_square.jpg")
